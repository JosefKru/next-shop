  ...
  return (
    <button
      className={`ease group relative z-30 box-border inline-flex ${
        width ? width : 'w-auto'
      } ${padding} cursor-pointer items-center justify-center overflow-hidden rounded bg-gradient-to-r from-[#fd831f] to-[#d5e100] px-8 py-3 font-bold text-white opacity-90 transition-all duration-300 hover:opacity-100 focus:outline-none`}
      onClick={onClick}
    >
